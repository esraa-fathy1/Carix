...
$run_select=mysqli_query($connect,$select_city);
            ...
            <div class="wrapper">
                <div class="inner">
                    <div class="image-holder">
                        <img src="../images/Forms/Address.svg" alt="">
                    </div>
                    <form method="POST">
                        <h3>Find Your Nearest Gas Station</h3>
                        <div class="form-holder">
                            <div class="row py-3">
                                <div class="col-6">
                                    <label for="city" class="form-label">City</label>
                                    <select id="city" aria-label="brand" class="form-select">
                                ...
                                <div class="col-6">
                                    ...
                                    <select id="area" aria-label="model" class="form-select">
                                        <option value="">Select Your Area</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <ul id="list" class="lh-lg gaStation">
                            <!-- <li>ChillOut Tayaran :
                                <a href="https://maps.app.goo.gl/zSujwT5sK9schm18A" target="_blank"
                                    rel="noopener noreferrer"> https://maps.app.goo.gl/zSujwT5sK9schm18A</a>
                            </li> -->
                            <!-- <li>Chillout Shinzo Abe :
                                <a href="https://maps.app.goo.gl/pYMRVwXcK5QncJs38" target="_blank"
                                    rel="noopener noreferrer">https://maps.app.goo.gl/pYMRVwXcK5QncJs38</a>
                            </li>
                            <li>Chillout Al-Moshier :
                                <a href="https://maps.app.goo.gl/Hxtwkf3fVJSWMQDu8" target="_blank"
                                    rel="noopener noreferrer">https://maps.app.goo.gl/Hxtwkf3fVJSWMQDu8</a>
                            </li>
                            <li>Chillout Al-Fardous :
                                <a href="https://maps.app.goo.gl/atf17YbY4N1YYQw9A" target="_blank"
                                    rel="noopener noreferrer">https://maps.app.goo.gl/atf17YbY4N1YYQw9A</a>
                            </li>
                            <li>Chillout Triumph :
                                <a href="https://maps.app.goo.gl/U6UAyBSFmU4PzHTAA" target="_blank"
                                    rel="noopener noreferrer">https://maps.app.goo.gl/U6UAyBSFmU4PzHTAA</a>
                            </li> -->
                        </ul>
                    </form>
                </div>

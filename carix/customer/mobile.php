...
if (isset($_POST['submit'])) {
    ...
    if (strlen($phone) != 11) {
        ...
        $token="fcfx50v0oquq8yq3"; // Ultramsg.com token
        $instance_id="instance86218"; // Ultramsg.com instance id
        $client = new UltraMsg\WhatsAppApi($token,$instance_id);

        $to="20".$phone; 
        $body="Hello Mr/Mrs $username we are Carix customer service,  Your bill is = $total EGP , if you accept this please enter your Verification code in the website : $otp"; 
        $api=$client->sendChatMessage($to,$body);
        // print_r($api);
        header("location:otpwhatsapp.php");
        // header("location:/projects/carix/customer/payment.php");
    }
}
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 selectForm usualForm pe-2">
                    <form id="form1" method="POST">
                        <h3>Almost there</h3>
                        <p>We are excited that you are starting with us, and hope you enjoy our services. We need your
                            your mobile number to create a wallet and referral code to you</p>
                        <hr>
                        <label for="mobile" class="form-label fw-bold">Mobile Number</label>
                        <input type="text" id="phone" placeholder="" class="form-control" name="phone">
                         <?php if($alert) { ?>
                        ...
                        <div class="btn-box">
                            <button type="submit" id="next" class="w-50" name="submit">Let's get Started</button>
                        </div>
                    </form>
                </div>
            </div>

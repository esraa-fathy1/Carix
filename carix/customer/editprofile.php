...
if (isset($_POST['edit'])) {
    ...
    if (empty($name)) {
        ...
        if ($email != $user_email) {
            ...
            $otp_update = strval(rand(100000, 999999));

            // Send the verification code to the user's email
            $mail->setFrom('carix2024@gmail.com', 'Carix');
            $mail->addAddress($email);
            $mail->isHTML(true);
            $mail->Subject = 'Update your Email in Carix';
            $mail->Body = "Your verification code is: $otp_update";
            $_SESSION['otp_update'] = $otp_update;

            if ($mail->send()) {
                header("location:updatedverify.php");
            ...
            // $_SESSION['test']="Your data updated successfully";
...
<body>
    ...
    <section class="mainBg py-3">
        <div class="container forms">
            ...
            <?php } ?>
            <?php if ($alert2) { ?>
            <div class="alert alert-success text-center w-100 m-auto">
                <strong>
                    <?php echo $alert2; ?>
                </strong>
            </div>
            ...
            <div class="wrapper">
                <div class="inner">
                    ...
                    <form method="POST">
                        <div class="code py-3 d-flex justify-content-between">
                            <h4>My Code</h4>
                            <h4><?php echo "$user_code"; ?></h4>
                        </div>
                        ...
                        <div class="form-holder">
                            <p>Email</p>
                            <input name="email" type="email" class="form-control" style="font-size: 15px;"
                                value="<?php echo $user_email; ?>">
                        </div>
                        <!-- <div class="form-holder">
                            <p>Mobile Number</p>
                            <input name="phone" type="text"  class="form-control" style="font-size: 15px;" value="<?php echo $user_phone; ?>">
                        </div> -->

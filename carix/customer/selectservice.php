...
if (isset($_POST['submit'])) {
    $_SESSION['service_type'] = $_POST['type'];
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 selectForm usualForm pe-2">
                    <form id="form3" method="POST">
                        ...
                        <p>Be assured of first class service from our expert staff, using the latest equipment to
                            deliver vehicle services, MOTs and repairs to the highest standard.</p>
                        <hr>
                        <label for="type" class="form-label fw-bold">Service Type</label>
                        <select id="savedAddress" aria-label="address" class="form-select py-2 mb-3" name="type">
                        ...
                        <div class="btn-box">
                            <button type="submit" id="back2" name="back">Back</button>
                            <button type="submit" id="next3" name="submit">Next</button>
                        </div>
                    </form>
                </div>
            </div>

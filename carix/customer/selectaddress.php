...
if (isset($_POST['next'])) {
    ...
    JOIN `areas` ON `user_address`.`area_id`=`areas`.`id`
    WHERE `user_address`.`user_id`=$user_id
    AND `user_address`.`add_id` = $address_id ";
    $run_address = mysqli_query($connect , $select_address);
    $array = mysqli_fetch_array($run_address);
    $_SESSION['area'] = $array['name'];
        ...
        <div class="container-fluid text-capitalize">
            ...
            <div class="collapse navbar-collapse centerNav" id="navbarSupportedContent">
                ...
                <div class="d-flex align-items-center gap-3">
                    <?php if (!isset($_SESSION['user'])) { ?>
                        <a class="nav-link rightUser px-3" href="signin.php"><i class="fa-solid fa-right-to-bracket"></i>&nbsp;Login</a>
                    <?php } ?>

                    <a class="nav-link rightNav" href="//api.whatsapp.com/send?phone=2<?php echo $web_phone ?>"><i class="fa-brands fa-whatsapp"></i></a>
                    <!--todo-------------------------------------------- Hotline ----------------------------------------------->
                    <a class="nav-link rightNav" href="#hotline"><img src="../images/services.png" alt="24" width="100%"></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 selectForm usualForm pe-2">
                    <form id="form2" method="POST">
                        ...
                        <p>Please select the place that you want us to reach you to</p>
                        <hr>
                        <label for="address" class="form-label fw-bold">Address</label>
                        <select name="address" id="savedAddress" aria-label="address" class="form-select py-2 mb-3">
                        ...
                        <div class="btn-box">
                            <button type="submit" id="back1" name="back">Back</button>
                            <button type="submit" id="next2" name="next">Next</button>
                        </div>
                    </form>
                </div>
            </div>

            ...
            <div class="wrapper">
                <div class="inner">
                    ...
                    <form method="POST" class="pt-0">
                        ...
                        <div class="form-holder passWord d-flex">
                            <input type="password" placeholder="Password" name="password" class="form-control" style="font-size: 15px;">
                            <!-- <i class="material-icon visibility">visibility_off</i>
                            <i class="far fa-eye visibility" id="icon"></i> -->
                        </div>
                        <div class="form-login d-flex flex-column">
                            <button  type="submit" name="login" class="w-50">Login</button>
                            <!-- <a href="" class="up">Login</a> -->
                            <p class="pt-4">New User? <a href="registration.php" class="in">Sign up</a></p>
                            <p class="">Forgot Password? <a href="./emailinput.php" class="in">Click here</a></p>
                        </div>

...
{
    $id=$_GET['delete'];
    $delete="DELETE FROM `user_address` WHERE `add_id`=$id";
    $run_delete=mysqli_query($connect,$delete);
    header("location:savedaddress.php");
}
    ...
    <section class="mainBg py-5">
        <div class="container multiSteps">
            <div class="row align-items-center">
                <div class="col-6">
                    <img src="../images/Forms/Address.svg" alt="Form Image" class="img-fluid">
                </div>
                <div class="col-6 selectForm usualForm pe-2">
                    <form id="form1" method="POST">
                        ...
                        <!-- <div class="custom-card">
                            <div
                                class="fw-bold border p-3 mb-3 d-flex gap-4 justify-content-between align-items-center">
                                <span>20 dr abd el shafy, Cairo, East Cairo</span>
                                <a href="" class="btn"><i class="fa-regular fa-trash-can fa-xl text-warning"></i></a>
                            </div>
                        </div> -->
                        ...
                        <div class="custom-card">
                            <div
                                class="fw-bold border p-3 mb-3 d-flex gap-4 justify-content-between align-items-center">
                                <span><?php echo $data['address'] ?>, <?php echo $data['name'] ?><br> <?php echo $data['city'] ?></span>
                                <a href="savedaddress.php?delete=<?php echo $data['add_id']; ?>" onclick="return confirm('Are you sure you want to delete this address?')" class="btn"><i class="fa-regular fa-trash-can fa-xl text-warning"></i></a>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="btn-box">
                            <button type="submit" class="w-50" name="add">Add new address </button>
                        </div>
                    </form>
                </div>
            </div>

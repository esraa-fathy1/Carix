...
if(isset($_POST['update'])){
    $code = $_POST['code'];
    $first_part = substr($code, 0, 5);
    $second_part =  substr($code, -6);
    if(strlen($code) != 11){
        echo  "<div class='alert alert-danger text-center w-50 m-auto'>
        <strong>code must be 11 characters!</strong><br>
    </div> ";
    }else
    if($first_part != 'carix'){
        echo  "<div class='alert alert-danger text-center w-50 m-auto'>
        <strong>code must start with carix!</strong><br>
    </div> " . $first_part;
    }else
    if(!is_numeric($second_part)){
        echo  "<div class='alert alert-danger text-center w-50 m-auto'>
        <strong>code must end with 6 numbers!</strong><br>
    </div> ";
    }
    else{
        ...
        if($count >= 1){
            echo  "<div class='alert alert-danger text-center w-50 m-auto'>
            <strong>code is already taken!</strong><br>
        </div> ";
        }
        else{
            $update = "UPDATE `users`
                ...
                <div class="inner">
                    ...
                    <form method="POST" class="pt-0">
                        ...
                        <div class="form-holder">
                            <input type="text" placeholder="Code" class="form-control" style="font-size: 15px;" name="code" value="<?php echo $array['code'] ; ?>">
                        </div>

...
if(isset($_POST['add'])){
    $area=$_POST['area'];
    $city=$_POST['city'];
    $insert="INSERT INTO `areas` VALUES(NULL,'$area','$city')";
...
if(isset($_GET['edit'])){
    ...
    $area_name=$fetch['name'];
    $city_name=$fetch['city'];

    if(isset($_POST['update'])){
        $area=$_POST['area'];
        $city=$_POST['city'];

        $update_area="UPDATE `areas` SET `city`='$city' , `name`='$area' WHERE `id`=$id";
        $run_update=mysqli_query($connect,$update_area);
                ...
                <div class="inner">
                    ...
                    <form method="POST" class="pt-0">
                        ...
                        <div class="form-holder">
                            <input name="area" type="text" value="<?php echo $area_name ?>" placeholder="Area Name" class="form-control" style="font-size: 15px;">
                        </div>
                        <div class="form-holder">
                            <input name="city" type="text" value="<?php echo $city_name ?>" placeholder="City" class="form-control" style="font-size: 15px;">
                        </div>
